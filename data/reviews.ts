export const reviews = [
  ...
  },
  {
    id: 3,
    author: "Erin Miller",
    title: "UX | XR | Product Designer in B2B SaaS",
    body: "I've had the pleasure of working with Fabian for a Natural Products platform, and his technical expertise, flexibility, and sense of humor have been extremely valuable to this project. He consistently turned complex design concepts into seamless, functional code while offering thoughtful suggestions to improve the user experience. Fabian's collaborative approach and attention to detail make him an exceptional developer to work with!",
  },
  {
    id: 4,
    author: "Giovanny Telon",
    title: "Quality Assurance Engineer",
    body: "Fabian is an excellent developer with extensive knowledge in React, NestJS, and AWS tools. He has a great ability to detect details and ensure the user experience aligns exactly with the design specifications.",
  },
  {
    id: 5,
